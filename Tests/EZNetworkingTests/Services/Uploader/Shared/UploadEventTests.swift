...
final class UploadEventTests {
    ...
    func sameCaseWithDifferentInputsAreNotEquatable() {
        ...
        let event3 = UploadEvent.completed("A".data(using: .utf8)!)
        let event4 = UploadEvent.completed("B".data(using: .utf8)!)
    ...
    private static let list: [UploadEvent] = [
        .progress(0.2),
        .progress(0.6),
        .completed("A".data(using: .utf8)!),
        .completed("B".data(using: .utf8)!),
