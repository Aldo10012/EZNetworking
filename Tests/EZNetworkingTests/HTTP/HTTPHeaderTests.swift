...
final class HTTPHeaderTests {
    ...
    private static let arguments: [(header: HTTPHeader, key: String, value: String)] = [
        ...
        (header: HTTPHeader.accept(.custon("custom_value")), key: "Accept", value: "custom_value"),
        ...
        (header: HTTPHeader.contentType(.custon("custom_value")), key: "Content-Type", value: "custom_value"),
